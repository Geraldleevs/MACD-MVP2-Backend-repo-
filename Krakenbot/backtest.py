...
def use_rsi(overbought, oversold):
	def formula(df):
		rsi = talib.RSI(df['Close'], timeperiod=14)
		return np.where(rsi > overbought, -1, np.where(rsi < oversold, 1, 0))
	return formula

def use_stochastic(k_period, d_period, overbought, oversold):
	def formula(df):
...
indicator_names = {
	...
	use_adx: 'ADX',
	use_aroon: 'Aroon',
	use_rsi(70, 30): 'RSI70_30',
	use_rsi(71, 31): 'RSI71_31',
	use_rsi(72, 32): 'RSI72_32',
	use_rsi(73, 33): 'RSI73_33',
	use_rsi(74, 34): 'RSI74_34',
	use_rsi(75, 35): 'RSI75_35',
	use_stochastic(14, 3, 80, 20): 'Stochastic14_3_80_20',
	use_stochastic(14, 3, 85, 15): 'Stochastic14_3_85_15',
	use_stochastic(10, 3, 80, 20): 'Stochastic10_3_80_20',
	use_stochastic(10, 3, 85, 15): 'Stochastic10_3_85_15',
	use_stochastic(21, 5, 80, 20): 'Stochastic21_5_80_20',
	use_stochastic(21, 5, 85, 15): 'Stochastic21_5_85_15',
	use_cci: 'CCI',

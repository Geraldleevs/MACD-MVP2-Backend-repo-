...
class FirebaseAnalysis:
	...
	def get_risk(self, token_id, timeframe: Literal['short', 'medium','long'], default = 'Risk'):
	...
	def get_description(self, token_id, timeframe: Literal['short', 'medium','long'], default = 'Summary'):
		doc = self.__analysis.document(token_id).get()
		if doc.exists:
